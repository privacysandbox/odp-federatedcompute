...
package com.google.ondevicepersonalization.federatedcompute.shuffler.aggregator;
...
@ComponentScan({
  "com.google.ondevicepersonalization.federatedcompute.shuffler.aggregator",
...
public class AggregatorApplication {
  ...
  /**
   * Entry point for the Aggregator application. This method initializes the Spring context with a
   * custom configuration file and starts the application.
   *
   * @param args Command-line arguments passed to the application
   */
  public static void main(String[] args) {
    // Change the config name from "application.properties" to "aggregator.properties".
    System.setProperty(Constants.SPRING_CONFIG_NAME, "aggregator");

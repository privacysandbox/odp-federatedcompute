...
package com.google.ondevicepersonalization.federatedcompute.shuffler.taskmanagement;
...
/** Task management service application. */
@Configuration
@EnableAutoConfiguration
@ComponentScan({
  "com.google.ondevicepersonalization.federatedcompute.shuffler.taskmanagement",
  "com.google.ondevicepersonalization.federatedcompute.shuffler.common"
})
public class TaskManagementApplication {

  /**
   * Entry point for the Task Management application. This method initializes the Spring context
   * with a custom configuration file and starts the application.
   *
   * @param args Command-line arguments passed to the application
   */
  public static void main(String[] args) {
    // Change the config name from "application.properties" to "taskmanagement.properties".
    System.setProperty(Constants.SPRING_CONFIG_NAME, "taskmanagement");

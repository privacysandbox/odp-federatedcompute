...
@Configuration
public class ModelUpdaterConfig {
  ...
  public String pubSubSubscription(String modelUpdaterPubsubSubscription) {
    // Set the pubSubSubscription bean to point to modelUpdaterPubsubSubscription

...
package com.google.ondevicepersonalization.federatedcompute.shuffler.collector;
...
public class CollectorApplication {
  ...
  /**
   * Entry point for the Collector application. This method initializes the Spring context with a
   * custom configuration file and starts the application.
   *
   * @param args Command-line arguments passed to the application
   */
  public static void main(String[] args) {
    // Change the config name from "application.properties" to "collector.properties".
    System.setProperty(Constants.SPRING_CONFIG_NAME, "collector");

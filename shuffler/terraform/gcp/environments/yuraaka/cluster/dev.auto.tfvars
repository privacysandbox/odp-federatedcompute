...
task_assignment_min_replicas = 1
task_assignment_max_replicas = 1
collector_min_replicas = 1
collector_max_replicas = 1
task_scheduler_min_replicas = 1
task_scheduler_max_replicas = 1
task_scheduler_cpu = 0.154
task_assignment_cpu = 0.154
collector_cpu = 0.250